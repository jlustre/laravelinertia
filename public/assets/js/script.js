...
if (contentwidth < '576') {
    ...
    $('.footer-title').on('click', function () {
        ...
        if ($(this).next().is(':hidden') == true) {
            ...
            $(this).find('span').replaceWith('<span class="according-menu float-end"><i class="fas fa-chevron-up"></i></span>');
            $(this).next().slideDown('normal');
        } else {
            $(this).find('span').replaceWith('<span class="according-menu float-end"><i class="fa-solid fa-angle-down"></i></span>');
        }
    });
