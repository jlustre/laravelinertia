                    ...
                    <div className="col-xxl-3 col-xl-4 d-none d-xl-block">
                        <div className="p-sticky">
                                ...
                                <div className="home-contain hover-effect">
                                    ...
                                    <div className="home-detail p-top-left home-p-medium">
                                        <div>
                                            ...
                                            <button onClick={(location.href = '#')} className="btn btn-animation btn-md mend-auto">
                            ...
                            <div className="ratio_medium section-t-space">
                                <div className="home-contain hover-effect">
                                    <img src="assets/images/vegetable/banner/11.jpg" className="img-fluid blur-up lazyload" alt="" />
                                    <div className="home-detail p-top-left home-p-medium">
                                        <div>
                                            <h4 className="text-yellow text-exo home-banner">Organic</h4>
                                            <h2 className="text-uppercase fw-normal text-russo theme-color mb-0">fresh</h2>
                            ...
                            <div className="section-t-space">
                                <div className="category-menu">
                                    ...
                                    <ul className="product-list d-block border-0 p-0">
                                        <li>
                                        ...
                                        <li>
                                            <div className="offer-product">
                                                <a href="#" className="offer-image">
                                                    <img src="assets/images/vegetable/product/25.png" className="blur-up lazyload" alt="" />
                                                </a>
                                    ...
                                    <div className="review-box">
                                        ...
                                        <div className="review-profile">
                                            <div className="review-image">
                                                <img src="assets/images/vegetable/review/1.jpg" className="img-fluid blur-up lazyload" alt="" />
                                            </div>
                    ...
                    <div className="col-xxl-9 col-xl-8">
                        ...
                        <div className="section-t-space section-b-space">
                            <div className="row g-md-4 g-3">
                                    ...
                                    <div className="banner-contain hover-effect">
                                        ...
                                        <div className="banner-details p-center-left p-4">
                                            <div>
                                                ...
                                                <button onClick={(location.href = '#')} className="btn btn-animation btn-sm mend-auto">
                                                    Shop Now <i className="fa-solid fa-arrow-right icon"></i>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div className="col-md-6">
                                    <div className="banner-contain hover-effect">
                                        <img src="assets/images/vegetable/banner/10.jpg" className="bg-img blur-up lazyload" alt="" />
                                        <div className="banner-details p-center-left p-4">
                                            <div>
                                                <h3 className="text-exo">50% offer</h3>
                        ...
                        <div className="product-border wow fadeInUp overflow-hidden">
                            <div className="product-box-slider no-arrow">
                                <div>
                                    <div className="row m-0">
                                        <div className="col-12 px-0">
                        ...
                        <div className="section-t-space">
                            <div className="banner-contain">
                                ...
                                <div className="banner-details p-center p-4 text-center text-white">
                                    <div>
                        ...
                        <div className="section-t-space section-b-space">
                            <div className="row g-md-4 g-3">
                                <div className="col-xxl-8 col-xl-12 col-md-7">
                                    <div className="banner-contain hover-effect">
                                        <img src="assets/images/vegetable/banner/12.jpg" className="bg-img blur-up lazyload" alt="" />
                                        <div className="banner-details p-center-left p-4">
                                            <div>
                                ...
                                <div className="col-xxl-4 col-xl-12 col-md-5">
                                    <a href="#" className="banner-contain hover-effect h-100">
                                        <img src="assets/images/vegetable/banner/13.jpg" className="bg-img blur-up lazyload" alt="" />
                                        <div className="banner-details p-center-left h-100 p-4">
                                            <div>
                                                <h2 className="text-kaushan fw-normal text-danger">20% Off</h2>
                                                <h3 className="theme-color mt-2 mb-2">SUMMRY</h3>
                            ...
                            <div className="banner-contain hover-effect">
                                ...
                                <div className="banner-details p-center banner-b-space w-100 text-center">
                                    <div>
                                        ...
                                        <h5 className="lh-sm text-content mx-auto mt-1">Save up to 5% OFF</h5>
                                        <button onClick={(location.href = '#')} className="btn btn-animation btn-sm mt-sm-3 mx-auto mt-2">
                                            Shop Now <i className="fa-solid fa-arrow-right icon"></i>
                                        </button>
                                    </div>
                                </div>
